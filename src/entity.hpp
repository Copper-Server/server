...
namespace mcCore {
	...
	public:
		...
		std::vector<EnviropementReaction> enviropement_reactions;
		...
		struct {
			...
			float16_t armor_protect;//used while entity got hit in armor and taked damage
