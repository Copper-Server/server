...
namespace copper_server::build_in_plugins::network::tcp {
    ...
    tcp_client_handle_status::tcp_client_handle_status(api::network::tcp::session* session)
        : tcp_client_handle(session) {
    }

    base_objects::network::tcp::client* tcp_client_handle_status::define_ourself(api::network::tcp::session* sock) {
