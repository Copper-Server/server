#ifndef SRC_BUILD_IN_PLUGINS_NETWORK_TCP_STATE_HANDSHAKING
#define SRC_BUILD_IN_PLUGINS_NETWORK_TCP_STATE_HANDSHAKING
...
namespace copper_server::build_in_plugins::network::tcp {
    ...
    public:
        tcp_client_handle_handshaking(api::network::tcp::session* sock);
...
#endif /* SRC_BUILD_IN_PLUGINS_NETWORK_TCP_STATE_HANDSHAKING */
