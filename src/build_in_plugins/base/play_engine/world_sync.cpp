...
namespace copper_server::build_in_plugins::base::play_engine {
    class world_sync : public plugin_auto_register<"base/play_engine/world_sync", world_sync> {
        ...
        static void entity_add_effect(api::ecs::entity self, api::ecs::entity target, uint32_t id, uint32_t duration, uint8_t amplifier, bool ambient, bool show_particles, bool show_icon, bool use_blend) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                ...
                *assigned_player << api::packets::client_bound::play::update_mob_effect{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
                    .effect = id,
                    .amplifier = amplifier,
        ...
        static void entity_attach(api::ecs::entity self, api::ecs::entity target, api::ecs::entity other_id) {
            ...
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::set_entity_link{
                    .attached_id = other_id.template get<api::ecs::com::entities::protocol_id>().value,
                    .holding_id = target.template get<api::ecs::com::entities::protocol_id>().value
                };
        };
        ...
        static void entity_break(api::ecs::entity self, api::ecs::entity target, int32_t x, int32_t y, int32_t z, uint8_t state) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player)
        ...
        static void entity_cancel_break(api::ecs::entity self, api::ecs::entity target, int32_t x, int32_t y, int32_t z) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::block_destruction{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
        ...
        static void entity_damage_with_source(api::ecs::entity self, api::ecs::entity target, [[maybe_unused]] float health, int32_t type_id, std::optional<api::ecs::entity> source, const std::optional<util::vector>& pos) {
            ...
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::damage_event{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
                    .source_damage_type_id = type_id,
                    .source_id = source.transform([](auto entity) { return (api::id::entity_id)entity.template get<api::ecs::com::entities::protocol_id>().value; }),
                    .source_direct_id = source.transform([](auto entity) { return (api::id::entity_id)entity.template get<api::ecs::com::entities::protocol_id>().value; }),
                    .source_pos = pos
                };
        };
        ...
        static void entity_damage_with_sources(api::ecs::entity self, api::ecs::entity target, [[maybe_unused]] float health, int32_t type_id, std::optional<api::ecs::entity> source, std::optional<api::ecs::entity> source_direct, const std::optional<util::vector>& pos) {
            ...
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::damage_event{
                    ...
                    .source_damage_type_id = type_id,
                    .source_id = source.transform([](auto entity) { return (api::id::entity_id)entity.template get<api::ecs::com::entities::protocol_id>().value; }),
                    .source_direct_id = source_direct.transform([](auto entity) { return (api::id::entity_id)entity.template get<api::ecs::com::entities::protocol_id>().value; }),
                    .source_pos = pos
                };
        };
        ...
        static void entity_deinit(api::ecs::entity self, api::ecs::entity target) {
            ...
            if (assigned_player) {
                *assigned_player << api::packets::client_bound::play::remove_entities{
                    .ids{target.template get<api::ecs::com::entities::protocol_id>().value}
                };
            }
        };
        ...
        static void entity_detach(api::ecs::entity self, api::ecs::entity target, [[maybe_unused]] api::ecs::entity other) {
            ...
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::set_entity_link{
                    .attached_id = target.template get<api::ecs::com::entities::protocol_id>().value,
                    .holding_id = -1
                };
        };
        ...
        static void entity_finish_break(api::ecs::entity self, api::ecs::entity target, int32_t x, int32_t y, int32_t z) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::block_destruction{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
        ...
        static void entity_init(api::ecs::entity self, api::ecs::entity target) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                auto velocity = target.template get<api::ecs::com::entities::motion>();
                auto pos = target.template get<api::ecs::com::entities::position>();
                auto rot = target.template get<api::ecs::com::entities::rotation>();
                auto head_rot = target.template get<api::ecs::com::entities::head_rotation>();
                *assigned_player << api::packets::client_bound::play::add_entity{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
                    .uuid = api::entity_id_map::get_uuid(target.template get<api::ecs::com::entities::protocol_id>().value),
                    .type = target.template get<api::ecs::com::entities::entity_type>().type,
                    .x = pos.x,
                    .y = pos.y,
                    .z = pos.z,
                    .pitch = rot.pitch,
        ...
        static void entity_leaves_ride(api::ecs::entity self, api::ecs::entity target, api::ecs::entity other) {
            ...
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::set_passengers{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
                    .passengers = other.template get<api::ecs::com::entities::ride_by_entity>().ride_by.convert_fn([](auto& entity) { return (base_objects::var_int32)entity.get_entity().template get<api::ecs::com::entities::protocol_id>().value; })
                };
        };
        ...
        static void entity_move(api::ecs::entity self, api::ecs::entity target, util::vector dif) {
            ...
            if (assigned_player) {
                ...
                *assigned_player << api::packets::client_bound::play::move_entity_pos{
                    ...
                    .delta_y = delta.y,
                    .delta_z = delta.z,
                    .on_ground = target.template get<api::ecs::com::entities::on_ground>().value
                };
            }
        };

        static void entity_place_block(api::ecs::entity self, api::ecs::entity target, bool is_main_hand, [[maybe_unused]] int32_t x, [[maybe_unused]] int32_t y, [[maybe_unused]] int32_t z, [[maybe_unused]] const base_objects::block& block) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::animate{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
        ...
        static void entity_place_block_entity(api::ecs::entity self, api::ecs::entity target, bool is_main_hand, [[maybe_unused]] int32_t x, [[maybe_unused]] int32_t y, [[maybe_unused]] int32_t z, auto) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::animate{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
        ...
        static void entity_rides(api::ecs::entity self, [[maybe_unused]] api::ecs::entity target, api::ecs::entity other_entity) {
            ...
            if (assigned_player)
                *assigned_player << api::packets::client_bound::play::set_passengers{
                    .id = target.template get<api::ecs::com::entities::protocol_id>().value,
                    .passengers = other_entity.template get<api::ecs::com::entities::ride_by_entity>().ride_by.convert_fn([](auto& entity) { return (base_objects::var_int32)entity.get_entity().template get<api::ecs::com::entities::protocol_id>().value; })
                };
        };
        ...
        static void entity_teleport(api::ecs::entity self, api::ecs::entity target, util::vector pos) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                auto mot = target.template get<api::ecs::com::entities::motion>();
                auto rot = target.template get<api::ecs::com::entities::rotation>();
        ...
        static void notify_biome_change(api::ecs::entity self, int32_t x, [[maybe_unused]] int32_t y, int32_t z, [[maybe_unused]] uint32_t biome_id) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {

                if (self.has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
                    if (ws.world) {
                        if (ws.chunk_processed(x, z))
                            ws.world->get_chunk_at(x, z, [&assigned_player](base_objects::world::chunk_data& chunk) {
        ...
        static void notify_block_change(api::ecs::entity self, int32_t x, int32_t y, int32_t z, const base_objects::block& block) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
                    if (ws.world) {
                        if (ws.chunk_processed(x, z)) {
        ...
        static void notify_block_destroy_change(api::ecs::entity self, int32_t x, int32_t y, int32_t z, const base_objects::block& block) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
                    if (ws.world) {
                        if (ws.chunk_processed(x, z)) {
                            ...
                            *assigned_player << api::packets::client_bound::play::block_update{
                                .location = {x, y, z},
                                .block = api::collection::block::air.id
                            };
                        }
                    }
                }
        ...
        static void notify_block_entity_change(api::ecs::entity self, int32_t x, int32_t y, int32_t z, api::ecs::entity block_entity) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
                    if (ws.world) {
                        if (ws.chunk_processed(x, z)) {
                            auto block_state = block_entity.template get<api::ecs::com::block_entity::block_id>().id;
                            *assigned_player << api::packets::client_bound::play::block_update{
                                .location = {x, y, z},
                                .block = block_state
                            };
                            *assigned_player << api::packets::client_bound::play::block_entity_data{
                                .location = {x, y, z},
                                .type = base_objects::block(block_state).block_entity_id(),
                                .data = block_entity.get_nbt()
                            };
                        }
                    }
                }
        ...
        static void notify_block_entity_destroy_change(api::ecs::entity self, int32_t x, int32_t y, int32_t z, api::ecs::entity block_entity) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
                    if (ws.world) {
                        if (ws.chunk_processed(x, z)) {
                            *assigned_player << api::packets::client_bound::play::level_event{
                                .event = api::packets::client_bound::play::level_event::event_id::block_break_and_sound,
                                .location = {x, y, z},
                                .data = block_entity.template get<api::ecs::com::block_entity::block_id>().id,
                                .disable_volume = false
                            };
                            *assigned_player << api::packets::client_bound::play::block_update{
                                .location = {x, y, z},
        ...
        static void notify_block_event(api::ecs::entity self, const base_objects::world::block_action& action, int32_t x, int32_t y, int32_t z) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
        ...
        static void notify_chunk(api::ecs::entity self, int32_t x, int32_t z, const base_objects::world::chunk_data& chunk) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
                    if (ws.world) {
                        if (ws.chunk_in_bounds(x, z)) {
                            if (assigned_player->packets_state.chunk_batch_size > assigned_player->packets_state.chunks_sent) {
                                ...
                                self.template modify<api::ecs::com::entities::world_syncing>()->mark_chunk(x, z, true);
                            }
                        }
                    }
                }
        ...
        static void notify_chunk_blocks(api::ecs::entity self, int32_t x, int32_t z, const base_objects::world::chunk_data& chunk) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
        ...
        static void notify_chunk_light(api::ecs::entity self, int32_t x, int32_t z, const base_objects::world::chunk_data& chunk) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
        ...
        static void notify_sub_chunk(api::ecs::entity self, int32_t x, [[maybe_unused]] int32_t y, int32_t z, [[maybe_unused]] const base_objects::world::sub_chunk_data& chunk) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
        ...
        static void notify_sub_chunk_blocks(api::ecs::entity self, int32_t x, [[maybe_unused]] int32_t y, int32_t z, [[maybe_unused]] const base_objects::world::sub_chunk_data& chunk) { //TODO use  api::packets::client_bound::play::section_blocks_update
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
        ...
        static void notify_sub_chunk_light(api::ecs::entity self, int32_t x, [[maybe_unused]] int32_t y, int32_t z, [[maybe_unused]] const base_objects::world::sub_chunk_data& chunk) {
            auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            if (assigned_player) {
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    auto& ws = self.template get<api::ecs::com::entities::world_syncing>();
                ...
                if (self.template has<api::ecs::com::entities::world_syncing>()) {
                    ...
                    if (ws.world) {
                        ...
                        *assigned_player << api::packets::client_bound::play::respawn{
                            ...
                            .is_debug = new_world.world_generator_data.contains("debug") ? (bool)new_world.world_generator_data["debug"].as_byte() : false,
                            .is_flat = new_world.world_generator_data.contains("flat") ? (bool)new_world.world_generator_data["flat"].as_byte() : false,
                            ...
                            .portal_cooldown = 0,
                            .sea_level = new_world.world_generator_data.contains("sea_level") ? new_world.world_generator_data["sea_level"].as_int() : 60,
                            .flags = api::packets::client_bound::play::respawn::keep_attributes | api::packets::client_bound::play::respawn::keep_metadata
                        };
                        self.modify<api::ecs::com::entities::world_syncing>()->flush_processing();
                    }
                }
            }
        }
                    ...
                    if (ws.world) {
                        if (!player.packets_state.is_play_initialized) {
                            ...
                            *assigned_player << api::packets::client_bound::play::set_chunk_cache_center{
                                .x = ws.processing_region.center_x,
                                .z = ws.processing_region.center_z,
                            };
                            *assigned_player << api::packets::client_bound::play::set_chunk_cache_radius{
                                .distance = ws.processing_region.radius
                            };
                        }
                        ...
                        if (max_unbc > player.packets_state.await_ack_chunk_batches) {
                            ...
                            ws.for_each_processing([&](int32_t chunk_x, int32_t chunk_z, bool loaded) {
                                if (!loaded) {
                                    if (player.is_active()) {
                                        if (player.packets_state.chunk_batch_size > player.packets_state.chunks_sent) {
                                            ...
                                            if (chunk) {
                                                if ((*chunk)->generator_stage == 0xFF) {
                                                    ...
                                                    self.template modify<api::ecs::com::entities::world_syncing>()->mark_chunk(chunk_x, chunk_z, true);
                                                }
                                            }
                                        }
                                    }
                        ...
                        if (make_tick) {
                            if (!player.packets_state.is_play_fully_initialized) {
                                ...
                                auto mot = self.template get<api::ecs::com::entities::motion>();
                                auto rot = self.template get<api::ecs::com::entities::rotation>();
        ...
        static void sync_time(api::ecs::entity self, uint32_t time, int64_t day_time) {
            //auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            //if (assigned_player) {
            //    *assigned_player << api::packets::client_bound::play::set_time{
            //        .time_of_day = time,
            //        .world_age = (uint64_t)day_time,
            //        .time_of_day_increment = false
            //    };
            //}
        }

        static void weather_change(api::ecs::entity self, uint32_t weather_time, base_objects::weather w) {
            //auto assigned_player = self.template get<api::ecs::com::entities::assigned_player>().player;
            //if (assigned_player) {
            //    *assigned_player << api::packets::client_bound::play::game_event{
            //        .event =
        ...
        static std::shared_ptr<api::entity_data::world_processor> make_processor() {
            ...
            proc.sync_time = sync_time;
            proc.weather_change = weather_change;
