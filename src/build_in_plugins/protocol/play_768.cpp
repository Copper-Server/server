...
namespace copper_server::build_in_plugins::protocol::play_768 {
    namespace play {
    ...
    class ProtocolSupport_768_play : public PluginAutoRegister<"protocol_support_for_768_play", ProtocolSupport_768_play> {
    public:
