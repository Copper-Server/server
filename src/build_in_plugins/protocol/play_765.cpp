...
namespace copper_server::build_in_plugins::protocol::play_765 {
    namespace play {
    ...
    class ProtocolSupport_765_play : public PluginAutoRegister<"protocol_support_for_765_play", ProtocolSupport_765_play> {
    public:
