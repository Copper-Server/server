...
#include <src/build_in_plugins/protocol/770/writers_readers.hpp>
#include <src/build_in_plugins/protocol/shared_encoding_packets.hpp>
...
namespace copper_server::build_in_plugins::protocol::play_770 {
    namespace encoding {
        class login_functions : public packets::registry::login_functions {
            ...
            base_objects::network::response encryptionRequest(const std::string& server_id, uint8_t (&verify_token)[4]) override {
                auto public_key = base_objects::network::tcp::server::instance().public_key_buffer();
                base_objects::network::response::item packet;
        ...
        class configuration_functions : public packets::registry::configuration_functions {
            base_objects::network::response requestCookie(const std::string& key) override {
                base_objects::network::response::item packet;
                packet.write_id(0x00);
        ...
        class play_functions : public packets::registry::play_functions {
            ...
            base_objects::network::response updateTime(int64_t world_age, int64_t time_of_day) override {
                list_array<uint8_t> packet;
    ...
    namespace decoding::play {
        void teleport_confirm(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void query_block_nbt(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void bundle_item_selected(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void change_difficulty(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_change_difficulty.async_notify({packet.read_value<uint8_t>(), *session, session->sharedDataRef()});
        }

        void acknowledge_message(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_acknowledge_message.async_notify({packet.read_var<int32_t>(), *session, session->sharedDataRef()});
        }

        void chat_command(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_chat_command.async_notify({packet.read_string(32769), *session, session->sharedDataRef()});
        }

        void signed_chat_command(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void chat_message(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void player_session(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void chunk_batch_received(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_chunk_batch_received.async_notify({packet.read_value<float>(), *session, session->sharedDataRef()});
        }

        void client_status(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_client_status.async_notify({packet.read_var<int32_t>(), *session, session->sharedDataRef()});
        }

        void client_tick_end(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_client_tick_end.async_notify({true, *session, session->sharedDataRef()});
        }

        void client_information(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void command_suggestion(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void switch_to_configuration(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void click_container_button(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void click_container(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void close_container(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_close_container.async_notify({packet.read_var<int32_t>(), *session, session->sharedDataRef()});
        }

        void change_container_slot_state(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void subscribe_to_debug_sample(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void edit_book(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void query_entity_tag(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void interact(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void jigsaw_generate(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void lock_difficulty(base_objects::network::tcp::session* session, ArrayStream& packet) {
            bool lock = packet.read();
            api::protocol::on_lock_difficulty.async_notify({lock, *session, session->sharedDataRef()});
        }

        void set_player_position(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void set_player_position_and_rotation(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void set_player_rotation(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void set_player_movement_flags(base_objects::network::tcp::session* session, ArrayStream& packet) {
            uint8_t flags = packet.read();
            api::protocol::on_set_player_movement_flags.async_notify({flags, *session, session->sharedDataRef()});
        }

        void move_vehicle(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void paddle_boat(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void pick_item_from_block(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void pick_item_from_entity(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void ping_request(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void place_recipe(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void player_abilities(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void player_action(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void player_command(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void player_input(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void player_loaded(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_player_loaded.sync_notify({true, *session, session->sharedDataRef()});
        }

        void change_recipe_book_settings(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void set_seen_recipe(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_set_seen_recipe.async_notify({packet.read_identifier(), *session, session->sharedDataRef()});
        }

        void rename_item(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_rename_item.async_notify({packet.read_identifier(), *session, session->sharedDataRef()});
        }

        void resource_pack_response(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void seen_advancements(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void select_trade(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_select_trade.async_notify({packet.read_var<int32_t>(), *session, session->sharedDataRef()});
        }

        void set_beacon_effect(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void set_held_item(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_set_held_item.async_notify({packet.read_value<int16_t>(), *session, session->sharedDataRef()});
        }

        void program_command_block(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void program_command_cart(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void set_creative_slot(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void program_jigsaw_block(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void program_structure_block(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void update_sign(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void swing_arm(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_swing_arm.async_notify({{packet.read_var<int32_t>()}, *session, session->sharedDataRef()});
        }

        void spectator_teleport(base_objects::network::tcp::session* session, ArrayStream& packet) {
            api::protocol::on_spectator_teleport.async_notify({{packet.read_uuid()}, *session, session->sharedDataRef()});
        }

        void use_item_on(base_objects::network::tcp::session* session, ArrayStream& packet) {
        ...
        void use_item(base_objects::network::tcp::session* session, ArrayStream& packet) {
    ...
    public:
        void OnRegister(const PluginRegistrationPtr& self) {
            ...
            packets::registry::register_protocol(770, {new encoding::login_functions(), new encoding::configuration_functions(), new encoding::play_functions()});
        }
        ...
        void OnUnregister(const PluginRegistrationPtr& self) {
            ...
            packets::registry::erase_protocol(770);
        }
    };
}