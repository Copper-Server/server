#ifndef SRC_BASE_OBJECTS_NETWORK_ACCEPT_PACKET_REGISTRY
#define SRC_BASE_OBJECTS_NETWORK_ACCEPT_PACKET_REGISTRY
...
namespace copper_server::base_objects::network {
    using read_packet_handler = void (*)(base_objects::network::tcp_session*, ArrayStream&);
...
#endif /* SRC_BASE_OBJECTS_NETWORK_ACCEPT_PACKET_REGISTRY */
