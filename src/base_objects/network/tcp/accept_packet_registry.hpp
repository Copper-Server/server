...
namespace copper_server::base_objects::network::tcp {
    using read_packet_handler = void (*)(api::network::tcp::session*, ArrayStream&);
    ...
    struct protocol_packet_registry_t {
        ...
        void handle(int32_t packet_state, api::network::tcp::session* session, ArrayStream& packet) const;
    ...
    struct accept_packet_registry {
        ...
        void handle(int32_t protocol_id, int32_t packet_state, api::network::tcp::session* session, ArrayStream& packet) const;
