...
namespace copper_server::base_objects::network {
    void protocol_packet_registry_t::handle(int32_t packet_state, base_objects::network::tcp_session* session, ArrayStream& packet) const {
    ...
    void accept_packet_registry::handle(int32_t protocol_id, int32_t packet_state, base_objects::network::tcp_session* session, ArrayStream& packet) const {
