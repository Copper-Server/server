...
namespace crafted_craft {
    struct Chat {
        ...
        ENBT ToENBT() const {
            ...
            if (clickEvent) {
                ENBT clickEvent_enbt(ENBT::Type::compound);
                if (clickEvent->open_url) {
            ...
            if (hoverEvent) {
                ENBT hoverEvent_enbt(ENBT::Type::compound);
                if (hoverEvent->show_item) {
                    ENBT show_item_enbt(ENBT::Type::compound);
                ...
                if (hoverEvent->show_entity) {
                    ENBT show_entity_enbt(ENBT::Type::compound);
            ...
            if (extra.size()) {
                ENBT extra_enbt(ENBT::Type::array);
                for (auto& it : extra) {
