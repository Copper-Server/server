#ifndef SRC_PROTOCOLHELPER_CLIENT_HANDLER_768_CONFIGURATION
#define SRC_PROTOCOLHELPER_CLIENT_HANDLER_768_CONFIGURATION
...
#endif /* SRC_PROTOCOLHELPER_CLIENT_HANDLER_768_CONFIGURATION */
