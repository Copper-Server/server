...
namespace copper_server {
    namespace client_handler {
        namespace abstract {
            base_objects::network::tcp::client* createhandle_login(base_objects::network::tcp::session* client) {
                return std::make_unique<handle_login>(client).release();
            }

            base_objects::network::tcp::client* createhandle_configuration(base_objects::network::tcp::session* client) {
                return std::make_unique<handle_configuration>(client).release();
            }

            base_objects::network::tcp::client* createhandle_play(base_objects::network::tcp::session* client) {
