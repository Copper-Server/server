#ifndef SRC_PROTOCOLHELPER_CLIENT_HANDLER_769_CONFIGURATION
#define SRC_PROTOCOLHELPER_CLIENT_HANDLER_769_CONFIGURATION
...
#endif /* SRC_PROTOCOLHELPER_CLIENT_HANDLER_769_CONFIGURATION */
