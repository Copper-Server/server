...
namespace copper_server {
    class keep_alive_solution {
        ...
        base_objects::network::tcp_session* session;
    ...
    class tcp_client_handle : public base_objects::network::tcp_client {
    ...
    protected:
        ...
        base_objects::network::tcp_client* next_handler = nullptr;
        base_objects::network::tcp_session* session;
    ...
    public:
        tcp_client_handle(base_objects::network::tcp_session* session);
