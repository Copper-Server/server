#ifndef SRC_PROTOCOLHELPER_PACKETS_768_PACKETS
#define SRC_PROTOCOLHELPER_PACKETS_768_PACKETS
    ...
    namespace packets {
        namespace release_768 {
            ...
            namespace play {
                ...
                Response syncEntityPosition(int32_t entity_id, Position);
                ...
                //TODO new packet 67
                Response synchronizePlayerRotation(float yaw, float pitch, uint8_t flags, int32_t teleport_id);
...
#endif /* SRC_PROTOCOLHELPER_PACKETS_768_PACKETS */
