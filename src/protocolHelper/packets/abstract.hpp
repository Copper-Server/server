#ifndef SRC_PROTOCOLHELPER_PACKETS_ABSTRACT
#define SRC_PROTOCOLHELPER_PACKETS_ABSTRACT
    ...
    namespace packets {
        namespace release_765 {
            ...
            namespace play {
                ...
                Response spawnEntity(SharedClientData& client, const base_objects::entity& entity);
                ...
                Response deleteMessage(SharedClientData& client, uint8_t signature[256]);

                Response deleteMessage(SharedClientData& client, int32_t message_id);
                ...
                Response explosion(SharedClientData& client, calc::VECTOR pos, float strength, list_array<calc::XYZ<int8_t>> affected_blocks, calc::VECTOR player_motion, int32_t block_interaction, int32_t small_explosion_particle_id, const base_objects::particle_data& small_explosion_particle_data, int32_t large_explosion_particle_id, const base_objects::particle_data& large_explosion_particle_data, const std::string& sound_name, std::optional<float> fixed_range);
                ...
                Response mapData(SharedClientData& client, int32_t map_id, uint8_t scale, bool locked, const list_array<base_objects::packets::map_icon>& icons = {}, uint8_t columns = 0, uint8_t rows = 0, uint8_t x = 0, uint8_t z = 0, const list_array<uint8_t>& data = {});
                ...
                Response playerInfoUpdate(SharedClientData& client, const list_array<base_objects::packets::player_actions_add>& add_players);
                Response playerInfoUpdate(SharedClientData& client, const list_array<base_objects::packets::player_actions_initialize_chat>& initialize_chat);
                Response playerInfoUpdate(SharedClientData& client, const list_array<base_objects::packets::player_actions_update_gamemode>& update_game_mode);
                Response playerInfoUpdate(SharedClientData& client, const list_array<base_objects::packets::player_actions_update_listed>& update_listed);
                Response playerInfoUpdate(SharedClientData& client, const list_array<base_objects::packets::player_actions_update_latency>& update_latency);
                Response playerInfoUpdate(SharedClientData& client, const list_array<base_objects::packets::player_actions_update_display_name>& update_display_name);
                ...
                Response updateRecipeBook(SharedClientData& client, bool add_remove, bool crafting_recipe_book_open, bool crafting_recipe_book_filter_active, bool smelting_recipe_book_open, bool smelting_recipe_book_filter_active, bool blast_furnace_recipe_book_open, bool blast_furnace_recipe_book_filter_active, bool smoker_recipe_book_open, bool smoker_recipe_book_filter_active, list_array<std::string> recipe_ids);
                ...
                Response serverData(SharedClientData& client, const Chat& motd, const std::optional<list_array<uint8_t>>& icon_png, bool secure_chat);
                ...
                Response setSimulationDistance(SharedClientData& client, float distance);
                ...
                Response entitySoundEffect(SharedClientData& client, const std::string& sound_id, std::optional<float> range, int32_t category, int32_t entity_id, float volume, float pitch, int64_t seed);
                ...
                Response soundEffect(SharedClientData& client, const std::string& sound_id, std::optional<float> range, int32_t category, int32_t x, int32_t y, int32_t z, float volume, float pitch, int64_t seed);


                Response startConfiguration(SharedClientData& client);
                Response stopSound(SharedClientData& client, uint8_t flags);
                Response stopSound(SharedClientData& client, uint8_t flags, int32_t source);
                Response stopSound(SharedClientData& client, uint8_t flags, const std::string& sound);
                Response stopSound(SharedClientData& client, uint8_t flags, int32_t source, const std::string& sound);
                ...
                Response entityEffect(SharedClientData& client, int32_t entity_id, int32_t effect_id, int8_t amplifier, int32_t duration, int8_t flags, std::optional<ENBT> factor_codec);
                //TODO:
                //Response updateRecipes()

                Response updateTags(SharedClientData& client, bool reset, const list_array<base_objects::packets::tag_mapping>& tag_mappings, const list_array<std::string>& remove_tags);
            }
        }
    }
}

#endif /* SRC_PROTOCOLHELPER_PACKETS_ABSTRACT */
