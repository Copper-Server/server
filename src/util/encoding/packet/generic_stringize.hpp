 ...
 */
#ifndef SRC_UTIL_ENCODING_PACKET_STRINGIZE
#define SRC_UTIL_ENCODING_PACKET_STRINGIZE
#include "src/util/encoding/nbt/serialization.hpp"

#include <src/util/encoding/common.hpp>

namespace copper_server::util::encoding::packet::sp {
    template <class T>
...
#pragma warning(disable : 4702)
    ...
    namespace detail {
        ...
        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
        ...
        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
            requires std::is_same_v<base_objects::optional_var_int32, Type> || std::is_same_v<base_objects::optional_var_int64, Type>
        {
            if (value)
            ...
            requires std::is_same_v<base_objects::chat, Type>
        {
            ...
            alignment[0] = '\n';
            res += list_array<char>(value.to_nbt().to_snbt(), false, true)
            ...
            requires std::is_same_v<util::nbt, Type>
        {
            std::string alignment(spacing + 1, ' ');
            alignment[0] = '\n';
            res += list_array<char>(value.to_snbt(), false, true)
                       .replace('\n', alignment.data(), alignment.size())
                       .to_container<std::string>();
        }
        ...
        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
            requires std::is_base_of_v<base_objects::palette_container, Type>
        {
            res += "palette_data";
        }
        ...
        {
            res += "palette_data_heimap";
        }

        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
            requires is_template_base_of<_list_array_impl::list_array, Type> || is_std_array<Type>
        {
        ...
        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
            requires is_template_base_of<base_objects::enum_as, Type>
        {
        ...
        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
            requires is_template_base_of<base_objects::enum_as_flag, Type>
        {
        ...
        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
            requires is_template_base_of<base_objects::or_, Type> || is_template_base_of<base_objects::bool_or, Type>
        {
        ...
        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
            requires is_template_base_of<std::unique_ptr, Type>
        {
            serialize_entry(res, spacing, *value);
        }
        ...
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<1>)
            requires is_template_base_of<base_objects::sized_entry, Type>
                     || is_template_base_of<base_objects::any_of, Type>
                     || is_template_base_of<base_objects::packet_compress, Type>
                     || is_limited_num<Type>
        {
        ...
        template <class Type>
        void serialize_impl(std::string& res, size_t spacing, const Type& value, priority_tag<0>) {
            bool process_next = true;
            bool processed = false;
            if constexpr (api::packets::is_packet<Type>)
        ...
        template <class T>
        void serialize_impl(std::string& res, size_t spacing, const T& value) {
        }
    }
...
#pragma warning(pop)
    ...
    template <class T>
    void serialize_entry(std::string& res, size_t spacing, const T& value) {
        detail::serialize_impl(res, spacing, value);
    }
...
#endif /* SRC_UTIL_ENCODING_PACKET_STRINGIZE */
