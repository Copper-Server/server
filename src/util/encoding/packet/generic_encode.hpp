...
namespace copper_server::util::encoding::packet {
    ...
    namespace detail {
        ...
        consteval bool need_preprocess_result(priority_tag<1>)
            requires is_std_array<T>
                     ...
                     || is_template_base_of<api::packets::value_optional, T>
                     || is_template_base_of<api::packets::sized_entry, T>
                     || is_template_base_of<api::packets::packet_compress, T>
        {
        ...
        template <class T, class... VisitedTypes>
        consteval bool need_preprocess_result(priority_tag<1>)
            requires is_flags_list_from<T> || is_template_base_of<api::packets::flags_list, T>
        {
            bool res = false;
        ...
        template <class T, class... VisitedTypes>
        consteval bool need_preprocess_result(priority_tag<1>)
            requires is_template_base_of<api::packets::enum_switch, T> || is_template_base_of<api::packets::partial_enum_switch, T>
        {
            bool res = false;
            T::for_each([&]<class IT>() {
                if (!res)
        ...
        template <class T, class... VisitedTypes>
        consteval bool need_preprocess_result(priority_tag<1>)
            requires is_template_base_of<api::packets::or_, T> || is_template_base_of<api::packets::bool_or, T>
        {
        ...
        template <class T, class...>
        consteval bool need_preprocess_result(priority_tag<1>)
            requires std::is_same_v<api::packets::identifier, T>
                     || std::is_same_v<api::packets::json_text_component, T>
                     || std::is_same_v<api::packets::var_int32, T>
                     || std::is_same_v<base_objects::velocity, T>
                     || std::is_same_v<api::packets::var_int64, T>
                     || std::is_same_v<api::packets::optional_var_int32, T>
                     || std::is_same_v<api::packets::optional_var_int64, T>
                     ...
                     || is_template_base_of<api::packets::ignored, T>
                     || is_template_base_of<api::packets::enum_as, T> || is_template_base_of<api::packets::enum_as_flag, T>
                     || is_template_base_of<api::packets::any_of, T>
                     || is_template_base_of<api::packets::id_set, T>
        ...
        template <class T, class... VisitedTypes>
        consteval bool need_preprocess_result(priority_tag<1>)
            requires is_template_base_of<api::packets::enum_set, T>
        {
        ...
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires base_objects::is_convertible_to_packet_form<std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<api::packets::identifier, std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires is_constant_value<std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires is_std_array<std::decay_t<Type>>
        {
            for (auto& it : value)
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires is_string_sized<std::decay_t<Type>>
        {
            res.write_string(value.value, std::decay_t<Type>::max_size);
        }

        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<api::packets::json_text_component, std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<api::packets::var_int32, std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<api::packets::var_int64, std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<base_objects::velocity, std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<api::packets::optional_var_int32, std::decay_t<Type>>
        {
            if (value)
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<api::packets::optional_var_int64, std::decay_t<Type>>
        {
            if (value)
                res.write_var64(static_cast<int64_t>(*value) + 1);
            else
                res.write_var64(0);
        }
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<base_objects::position, std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_arithmetic_v<std::decay_t<Type>>
        {
            res.write_value(value);
        }
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<std::string, std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<base_objects::uuid, std::decay_t<Type>>
        {
            res.write_value(value);
        }
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires std::is_same_v<base_objects::chat, std::decay_t<Type>>
        {
        ...
        {
            res.write_direct(util::nbt_convert::build(value.take_map()).get_as_network());
        }
        ...
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires std::is_base_of_v<base_objects::palette_container, std::decay_t<Type>>
        {
            std::visit(
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires std::is_same_v<base_objects::palette_data_height_map, std::decay_t<Type>>
        {
            res.write_array(((base_objects::palette_data&&)value).get());
        }

        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<2>)
            requires is_template_base_of<api::packets::list_array_depend, Type>
        {
        ...
        template <class T>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, T&& value, priority_tag<1>)
            requires is_template_base_of<_list_array_impl::list_array, T>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_template_base_of<api::packets::enum_as, Type> || is_template_base_of<api::packets::enum_as_flag, Type>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_template_base_of<api::packets::or_, Type>
        {
            using T = std::decay_t<Type>;
            std::visit(
                [&]<typename it_T>(it_T& it) {
                    if constexpr (std::is_same_v<typename T::var_0, std::decay_t<it_T>>) {
                        if constexpr (is_template_base_of<api::packets::enum_as, typename T::var_0>)
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_template_base_of<api::packets::bool_or, Type>
        {
            using T = std::decay_t<Type>;
            std::visit(
                [&](auto& it) {
                    res.write_value(std::is_same_v<typename T::var_0, std::decay_t<decltype(it)>>);
                    serialize_entry(res, context, it);
                },
                value
            );
            ...
            requires is_template_base_of<api::packets::enum_switch, Type>
        {
            ...
            std::visit(
                [&]<typename it_T_>(it_T_& it) {
                    ...
                    serialize_entry(res, context, typename T::encode_type(it_T::item_id::value));
                    serialize_entry(res, context, it);
                },
                value
            );
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_template_base_of<api::packets::partial_enum_switch, Type>
        {
            using T = std::decay_t<Type>;
            std::visit(
                [&]<typename T_it>(T_it& it) {
                    using it_T = std::decay_t<T_it>;
                    if constexpr (std::is_same_v<it_T, typename T::encode_type>) {
                        serialize_entry(res, context, it);
                    } else {
                        serialize_entry(res, context, typename T::encode_type(it_T::item_id::value));
                        serialize_entry(res, context, it);
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_template_base_of<api::packets::packet_compress, Type>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_template_base_of<std::unordered_map, Type>
        {
            res.write_var32_check(value.size());
            for (auto& [key, it] : value) {
                serialize_entry(res, context, key);
                serialize_entry(res, context, it);
            }
        }
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_flags_list_from<std::decay_t<Type>>
        {
            value.for_each_in_order([&](auto& it) {
                serialize_entry(res, context, it);
            });
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_template_base_of<api::packets::id_set, Type>
        {
            std::visit(
                [&]<typename it_T>(it_T& it) {
                    if constexpr (std::is_same_v<api::packets::identifier, std::decay_t<it_T>>) {
                        res.write_var32(0);
            ...
            requires is_template_base_of<api::packets::sized_entry, Type>
        {
            ...
            if constexpr (sizeof(typename T::size_type) >= 8)
                size = inner.data.size();
            else if constexpr (sizeof(typename T::size_type) >= 4)
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_limited_num<std::decay_t<Type>>
        {
            serialize_entry(res, context, value.value);
        }
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_bitset_fixed<std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires std::is_same_v<bit_list_array<uint64_t>, std::decay_t<Type>>
        {
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires api::id::is_source<std::decay_t<Type>> || is_template_base_of<api::packets::depends_next, Type>
        {
            serialize_entry(res, context, value.value);
        }
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_ordered_id<std::decay_t<Type>>
        {
            serialize_entry(res, context, value.value);
        }
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires is_template_base_of<api::packets::enum_set, Type>
        {
            using T = std::decay_t<Type>;
            using Tupple_T = std::decay_t<decltype(value.values)>;
            {
                ...
                size_t i = 0;
                util::for_each_type<Tupple_T>::each([&]<class T_Elem>() {
                    if constexpr (!std::is_same_v<typename T_Elem::value_type, typename T::header_t>) {
            ...
            if (check) {
                size_t siz = *check;
                if (siz)
                    if (!value.template has<typename T::header_t>())
        ...
        template <class Type>
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<1>)
            requires make_packet_as_nbt<std::decay_t<Type>>
        {
            std::stringstream ss;
        ...
        void serialize_impl(base_objects::network::response_item& res, base_objects::shared_client_data& context, Type&& value, priority_tag<0>) {
            ...
            reflect::for_each_field(value, [&value, &res, &context, &process_next]<class IT>(IT& item) {
                if (process_next) {
                    ...
                    if constexpr (is_template_base_of<api::packets::depends_next, IT>)
        ...
        void preprocess_structure(base_objects::shared_client_data& context, T& value, T_prev& prev, priority_tag<1>)
            requires(is_no_size<std::decay_t<T>>)
        {
        ...
        template <class T, class T_prev>
        void preprocess_structure(base_objects::shared_client_data& context, T& value, T_prev& prev, priority_tag<1>)
            requires(is_list_array_fixed<std::decay_t<T>>)
        {
        ...
        template <class T, class T_prev>
        void preprocess_structure(base_objects::shared_client_data& context, T& value, T_prev& prev, priority_tag<1>)
            requires(is_std_array<std::decay_t<T>> || is_template_base_of<_list_array_impl::list_array, T>)
        {
            if constexpr (need_preprocess_result_v<typename T::value_type>)
                for (auto& it : value)
                    preprocess_structure(context, it, prev);
        ...
        template <class T, class T_prev>
        void preprocess_structure(base_objects::shared_client_data& context, T& value, T_prev& prev, priority_tag<1>)
            requires(is_list_array_sized<std::decay_t<T>>)
        {
        ...
        template <class T, class T_prev>
        void preprocess_structure(base_objects::shared_client_data& context, T& value, T_prev& prev, priority_tag<1>)
            requires(is_template_base_of<api::packets::value_optional, T>)
        {
            if constexpr (need_preprocess_result_v<typename T::value_type>)
                if (value.rest)
        ...
        template <class T, class T_prev>
        void preprocess_structure(base_objects::shared_client_data& context, T& value, T_prev& prev, priority_tag<1>)
            requires(is_flags_list_from<std::decay_t<T>> || is_template_base_of<api::packets::flags_list, std::decay_t<T>>)
        {
        ...
        template <class T, class T_prev>
        void preprocess_structure(base_objects::shared_client_data& context, T& value, T_prev& prev, priority_tag<1>)
            requires(is_template_base_of<api::packets::depends_next, T> || is_template_base_of<api::packets::sized_entry, T> || is_template_base_of<api::packets::packet_compress, T>)
        {
            if constexpr (need_preprocess_result_v<typename T::value_type>)
        ...
        void preprocess_structure(base_objects::shared_client_data& context, T& value, T_prev& prev, priority_tag<1>)
            requires(
                std::is_same_v<api::packets::identifier, T>
                || std::is_same_v<api::packets::json_text_component, T>
                || std::is_same_v<api::packets::var_int32, T>
                || std::is_same_v<api::packets::var_int64, T>
                || std::is_same_v<api::packets::optional_var_int32, T>
                ...
                || std::is_same_v<base_objects::palette_data_height_map, T>
                || is_template_base_of<api::packets::ignored, T>
                || is_template_base_of<api::packets::enum_as, T>
                || is_template_base_of<api::packets::enum_as_flag, T>
                || is_template_base_of<api::packets::any_of, T>
                || is_template_base_of<api::packets::id_set, T>
                || std::is_same_v<bit_list_array<uint64_t>, T>
                || base_objects::is_convertible_to_packet_form<T>
    ...
    void make_preprocess(base_objects::shared_client_data& context, Type& value) {
        if constexpr (detail::need_preprocess_result_v<std::decay_t<Type>>) {
