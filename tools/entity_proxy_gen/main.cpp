...
std::map<std::string, std::pair<std::string, std::string>> type_map = {
    ...
    {"List<ParticleEffect>", {"std::vector<base_objects::entity_metadata::particle>", "base_objects::entity_metadata::particles"}},
    ...
    {"Oxidizable$OxidationLevel", {"base_objects::entity_metadata::weathering_copper_state", "entity_metadata::weathering_copper_state"}},
